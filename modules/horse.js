...
var HELP =
  "Ping horsejs and they will deliver you a fresh, randomly selected tweet from the twitter account @horsejs. Also reacts on JS-related keywords.";
...
function onMessage(say, from, chan, message) {
  for (var kw in keywordMap) {
    ...
    if (maybeSetCensorship) maybeSetCensorship(chan);
...
module.exports = function(context, params) {
  ...
  repeatPromise(getTweet, numPreloadTweets).then(
    function(tweets) {
