...
function onMessage(say, from, chan, message) {
  ...
  if (tryQ !== null) {
    ...
    for (var i = 0; i < q.length; i++) {
      if (
        typeof maybeWhat === "undefined" ||
        q[i].what.indexOf(maybeWhat) >= 0
      ) {
...
module.exports = function(context, params) {
  ...
  return {
    ...
    exports: {
      description:
        "Fortunes-like module: save quotes of people for later out-of-context lulz.",
      help:
        "- To save SOMEBODY's quote, assuming this quote includes the text 'HELLO', just do !aq SOMEBODY HELLO\n" +
        "This bot has been configured to memorize the last " +
        BACKLOG_MEMORY +
        " messages of each person only.\n" +
